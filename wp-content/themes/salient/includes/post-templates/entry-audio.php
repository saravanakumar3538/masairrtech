	...
	<div class="inner-wrap animated">
		...
		<div class="post-content">
			...
			<?php 
				...
				if($using_masonry == true && $masonry_type == 'classic_enhanced' && !is_single() || $using_masonry == true && $masonry_type == 'material' && !is_single() ) echo'<a href="' . get_permalink() . '" class="img-link"><span class="post-featured-img">'.get_the_post_thumbnail($post->ID, $img_size, array('title' => '')) .'</span></a>'; 
			?>
